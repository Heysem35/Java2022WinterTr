...
public class MethodCration_soru1 {
    static int rakam = 0;
    ...
    private static void buyukMuKucukMu(int sayi) { if (sayi >= 100 && sayi <= 999) {
    ...
    private static void negatinMiPozitivMi(int sayi) {if (sayi >= 0) {
