package JavaPractice.practice_basic_day04;
...
public class Q07_Arrays {
    public static void main(String[] args) {
        ...
        int min=Integer.MAX_VALUE; // min=0 yazınca da kod doğru çalışıyor
        ...
        System.out.println("girdiginiz arr nin en kucuk sayısı: "+min);
